...
const SummaryScreen: React.FC<SummaryScreenProps> = ({
  ...
  className="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl p-6 sm:p-8 bg-white/90 backdrop-blur-md shadow-2xl rounded-3xl border-2 border-pink-100 text-center"
      >        <motion.h2 
