 ...
 * 
 * Legacy Component: QuestionCard
 * Purpose: Displays blame questions with category and text
 * Dependencies: Card components, Question type interface
 * Migration Target: games/nameblame/components/QuestionCard.tsx
 */
